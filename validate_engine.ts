 ...
 */
import { MODELS, SCENARIOS, SEASONALITY } from './src/engine/model-registry';
import { runProjection, calcPaybackMetrics, calcFixedCosts, calcVarRate, generateChecklist, evaluateAlerts, runSensitivity } from './src/engine/financial-model';
