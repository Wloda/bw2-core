 ...
 */
import { MODELS, SEASONALITY } from '../data/model-registry.js?v=bw37';
...
export function evaluateAlerts(r) {
  ...
  if(r.months.length>=18&&r.months[17].cumulativeCashFlow<0) alerts.push({severity:'warning',icon:'📉',label:'Payback > 18m',message:`Faltan $${Math.round(Math.abs(r.months[17].cumulativeCashFlow)).toLocaleString()} por recuperar`});
